...
export const CANDIDATE_ROUTES: RouteSpec[] = [
  ...
  { path: '/app/resume', name: 'resume editor', audience: 'candidate' },
  { path: '/app/resume-builder', name: 'resume builder', audience: 'candidate' },
  { path: '/app/resume-generate', name: 'resume generate', audience: 'candidate' },
